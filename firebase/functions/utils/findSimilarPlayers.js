 ...
 * @param {*} min total minutes played
 * @param {*} gp total games played
 * @returns normalized stat
 */
const normalizeStats = (stat, min, gp) => {
 ...
 */
const findSimilarPlayers = (player, nbaPlayers) => {
...
module.exports = findSimilarPlayers;
